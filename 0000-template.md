...
> There are a lot of ways the Design System is is used. It's integrated with different libraries; etc. No one
> person knows everything about all the ways the Design system is used. What does someone who
> knows about the Design System but hasn't necessarily used anything outside of it need to
...
> designs or make them better fit the Ashley Design System.
...
> Would the acceptance of this proposal mean the Design System's guides must be
re-organized or altered? Does it change how it is taught to new users
at any level?
...
> Why should we *not* do this? Please consider the impact on teaching people to use the Design System,
